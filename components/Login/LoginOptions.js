...
const LoginOptions = () => {
  ...
  return (
    ...
    >
      <SafeAreaView
        style={[tw`py-2 flex flex-col h-full`, SafeArea.AndroidSafeArea]}
      >
        <View>
          <View style={tw`w-full px-10 py-3 mt-15 mb-17`}>
            <Text style={tw`text-5xl font-bold text-white`}>Hello!</Text>
        ...
        <View style={tw`w-full px-8`}>
          ...
          >
            ...
            />
            <TouchableOpacity>
              <Text style={tw`text-xs mb-1 px-2 text-[#00A3EA]`}>
            ...
            {message ? (
              <View style={tw`h-6 justify-center px-3 mb-2 mt-1`}>
                <Text style={tw`font-light tracking-[.20] text-red-600`}>
                  {message}
                </Text>
              </View>
            ) : signInWarn ? (
          ...
          <Text style={tw`text-center text-white font-bold`}>or</Text>
          <BlurView
            intensity={20}
            style={tw`w-full rounded-xl overflow-hidden px-3 py-3 mt-1`}
          >
            <TouchableOpacity
              style={tw`flex flex-row items-center w-full px-5`}
            >
              <Image
                style={tw`w-6 h-6`}
          ...
          >
            <Text style={tw`my-3`}>
              ...
              <Text style={tw`text-[#00A3EA] font-bold`}> Sign up</Text>
            </Text>
          </TouchableOpacity>
        </View>
        <RBSheet
